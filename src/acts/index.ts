...
import EscClientes from "./EscClientes";
...
export const ESCENAS: Escena[] = [
  ...
  { id: "catalogo", cap: 2, label: "99.985 títulos (cola larga)", pres: "HV", min: 1.3, Comp: Act04Catalogo },
  { id: "clientes", cap: 2, label: "722 clientes, punto a punto", pres: "HV", min: 1.5, field: "clientes", Comp: EscClientes },
